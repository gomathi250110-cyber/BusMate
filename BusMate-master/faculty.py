...
def faculty_registration():
    ...
    if not name or not faculty_id or not email or not password:
...
def calculate_return_times(
    ...
    first_stop_name = reversed_stops[0][0]
...
def view_return_bus():
    ...
    # Exam afternoon buses are excluded
    # from the normal return bus list.
    ...
    for (
        ...
        return_times = calculate_return_times(
            departure_time,
            morning_stops
        )
